...
const CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hdr-title { flex:1; font-family:'Quicksand',sans-serif; font-size:21px; font-weight:700; font-style:normal; line-height:1.1; letter-spacing:0; white-space:nowrap; -webkit-text-stroke:0.4px #fff; }
  .hdr-title em { font-family:'Horizon',sans-serif; font-style:normal; font-weight:normal; font-size:22px; letter-spacing:2px; -webkit-text-stroke:0; }
...
function FazendaScreen({fazenda,protocolos,vacas=[],onAddVaca,onUpdVaca,onDelVaca,onBack,onAddProtocolo,onUpdProtocolo,onUpdFazenda,onOpenProtocolo,onOpenVaca,onDelete,setModal,ping}){
  ...
  const[qVaca,setQVaca]=useState("");
  const vacasFiltradas=vacas.filter(v=>((v.nome||"")+(v.numero||"")).toLowerCase().includes(qVaca.toLowerCase().trim()));
  return <div>
    <div className="hdr">
    ...
    <div className="scr">
      ...
      {/* Protocolos primeiro — ação principal sempre acessível, sem rolar o rebanho */}
      ...
      {vacas.length>0&&!editVaca&&<div style={{position:"relative",marginBottom:10}}>
        <span style={{position:"absolute",left:10,top:"50%",transform:"translateY(-50%)",color:"var(--gr3)"}}><Icon name="search" size={16}/></span>
